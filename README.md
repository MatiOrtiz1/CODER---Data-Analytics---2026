...
Este repositorio forma parte de mi formación en Data Analytics en Coderhouse.

Referencias de los archivos consultados:
*  Propuesta de Análisis CoffeeInsight
*  Curaduría de Texto para Mapa Conceptual
*  Brief Analítico: RetailPro
*  Curaduría de Texto para Mapa Conceptual
*  Diseño Modelo Datos RetailPro
*  Curaduría de Texto para Mapa Conceptual
*  Brief Analítico: RetailPro
*  Normalización de Base de Datos RetroVibes
*  Curaduría de Texto para Mapa Conceptual
